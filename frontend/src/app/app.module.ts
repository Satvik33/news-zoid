...
@NgModule({
  declarations: [AppComponent, HeaderComponent, NavbarComponent, TrendingvideosComponent, FooterComponent, DashboardComponent, UserRegistrationComponent, HomeComponent],
